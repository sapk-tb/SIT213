...
public class TransducteurEmetteur extends Transducteur<Boolean, Boolean> {
    ...
    /**
     * reçoit l'information initiale à laquelle il faut rajouter le codage de
     * source
     *
     * @param info
    ...
    public void emettre() throws InformationNonConforme {
        ...
        informationGeneree = new Information<>(informationRecue.nbElements() * 3);//L'information envoyée sera 3 fois plus longue
